...
echo iterating!!!!!    
echo $i
mysql -h 127.0.0.1 -u root --password=FrozenMixedVegetables -e 'select 
...
inner join inbred_line_allele ila 
...
where pos >= '$((i*10000000-10000000))' and pos<'$((i*10000000))';' rachel_x > /data/doreper/output$i.txt
done
